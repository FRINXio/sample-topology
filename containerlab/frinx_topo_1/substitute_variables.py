...
def replace_variables(template_file, device_name, script_path):
    ...
    file_path = os.path.join(script_path, f'config_{device_name}.partial.txt')
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python3 substitute_variables.py device_templates/config_r1_pe1.template.txt device_templates/config_r1_pe2.template.txt ...")
    else:
        main(sys.argv[1:])
