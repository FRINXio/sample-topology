...
class XRV_vm(vrnetlab.VM):
    ...
    def bootstrap_spin(self):
        ...
        (ridx, match, res) = self.tn.expect(
            [
                ...
                b"Username:",
                b"RP/0/0/CPU0:ios#",
                b"SYSTEM CONFIGURATION COMPLETED",
            ],
            1,
        )
        if match:  # got a match!
            ...
            if ridx == 1:  # matched login prompt, so should login
    ...
    def bootstrap_config(self):
        ...
        self.wait_write("interface MgmtEth0/0/CPU0/0")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ram", type=int, default=4096, help="Number RAM to use in MB"
    )
    parser.add_argument(
        "--connection-mode",
        default="vrxcon",
